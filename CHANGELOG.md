...
- Fixed `devenv processes start <name>` starting a selected process when no process manager is already running ([#2930](https://github.com/cachix/devenv/issues/2930)).
